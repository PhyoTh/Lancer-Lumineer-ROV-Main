'''
Purpose: To test if the joystick works properly
Usage: None (individual script)
'''

# This script is only printing the joystick input values to the console
import pygame
...
# This script is moving a rectangle on the screen based on joystick input
# import pygame
